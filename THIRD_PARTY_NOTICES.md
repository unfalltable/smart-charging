...
This product uses third-party open-source software. The list below records the principal direct components in the
commercial build; transitive components are recorded in the generated CycloneDX SBOM and remain subject to their own
license terms.

| Component | License |
| --- | --- |
| Spring Boot, Spring Security, Spring Data, Spring Modulith | Apache License 2.0 |
| Flyway Community | Apache License 2.0 |
| PostgreSQL JDBC driver | BSD 2-Clause License |
| Netty | Apache License 2.0 |
| NATS Java client | Apache License 2.0 |
